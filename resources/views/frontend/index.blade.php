                ...
                <div class="block-slideshow__carousel">
                    <div class="owl-carousel">
                        @forelse(($slides ?? collect()) as $slide)
                            <a class="block-slideshow__item" href="{{ $slide->button_url ?: route('shop') }}">
                                <span class="block-slideshow__item-image block-slideshow__item-image--desktop"
                                    style="background-image: url('{{ asset($slide->desktop_image) }}')"></span>
                                <span class="block-slideshow__item-image block-slideshow__item-image--mobile"
                                    style="background-image: url('{{ asset($slide->mobile_image ?: $slide->desktop_image) }}')"></span>
                                @if(!empty($slide->offer_text))
                                    <span class="block-slideshow__item-offer">{{ $slide->offer_text }}</span>
                                @endif
                                @if(!empty($slide->title))
                                    <span class="block-slideshow__item-title">{!! nl2br(e($slide->title)) !!}</span>
                                @endif
                                @if(!empty($slide->details))
                                    <span class="block-slideshow__item-details">{!! nl2br(e($slide->details)) !!}</span>
                                @endif
                                <span class="block-slideshow__item-button">{{ $slide->button_text ?: 'Shop now' }}</span>
                            </a>
                        @empty
                            <a class="block-slideshow__item" href="{{ route('shop') }}">
                                <span class="block-slideshow__item-image block-slideshow__item-image--desktop"
                                    style="background-image: url('{{ asset('frontend/images/cache/slide-3.2c5baab142e50b7ae694282607f878872.jpg') }}')"></span>
                                <span class="block-slideshow__item-image block-slideshow__item-image--mobile"
                                    style="background-image: url('{{ asset('frontend/images/cache/slide-3-mobile.2f114400cbd154facd84171d91d7570e2.jpg') }}')"></span>
                                <span class="block-slideshow__item-offer">30% OFF</span>
                                <span class="block-slideshow__item-title">When Buying Parts<br>With Installation</span>
                                <span class="block-slideshow__item-details">Installation of parts in the services of<br>our partners.</span>
                                <span class="block-slideshow__item-button">Shop now</span>
                            </a>

                            <a class="block-slideshow__item" href="{{ route('shop') }}">
                                <span class="block-slideshow__item-image block-slideshow__item-image--desktop"
                                    style="background-image: url('{{ asset('frontend/images/cache/slide-2.2c5baab142e50b7ae694282607f878872.jpg') }}')"></span>
                                <span class="block-slideshow__item-image block-slideshow__item-image--mobile"
                                    style="background-image: url('{{ asset('frontend/images/cache/slide-2-mobile.2f114400cbd154facd84171d91d7570e2.jpg') }}')"></span>
                                <span class="block-slideshow__item-offer">45% OFF</span>
                            ...
                            <a class="block-slideshow__item" href="{{ route('shop') }}">
                                <span class="block-slideshow__item-image block-slideshow__item-image--desktop"
                                    style="background-image: url('{{ asset('frontend/images/cache/slide-1.2c5baab142e50b7ae694282607f878872.jpg') }}')"></span>
                                <span class="block-slideshow__item-image block-slideshow__item-image--mobile"
                                    style="background-image: url('{{ asset('frontend/images/cache/slide-1-mobile.2f114400cbd154facd84171d91d7570e2.jpg') }}')"></span>
                                <span class="block-slideshow__item-offer">25% OFF</span>
            ...
            <div class="container">
                <div class="section-header">
                    <div class="section-header__body">
                        <h2 class="section-header__title">Hot Deals</h2>
            ...
            <div class="block-sale__content">
                <div class="block-sale__header">
                    ...
                    <div class="block-sale__controls">
                        ...
                        <div class="block-sale__link"></div>
    ...
    C-0.1,9.8-0.1,10.4,0.3,10.7z" />
                ...
                <div class="block-sale__body">
                    ...
                    <div class="block-sale__image"
                        style="background-image: url('frontend/images/sale-1903x640.jpg');"></div>
                    <div class="container">
        ...
        <!--Promotion Banner -->
        @if ($promotionBanners && count($promotionBanners) > 0)
        <div class="block-space block-space--layout--divider-nl"></div>
        <div class="block-banners block">
            <div class="container">
                <div class="block-banners__list">

                    @forelse(($promotionBanners ?? collect()) as $banner)
                        <a href="{{ $banner->url ?: route('shop') }}"
                            class="block-banners__item block-banners__item--style--one">
                            <span class="block-banners__item-image"><img
                            ...
                            @if(!empty($banner->title))
                                <span class="block-banners__item-title">{{ $banner->title }}</span>
                            @endif
                            @if(!empty($banner->details))
                                <span class="block-banners__item-details">{!! nl2br(e($banner->details)) !!}</span>
                            @endif
                    ...
                    @empty
                        <a href="{{ route('shop') }}" class="block-banners__item block-banners__item--style--one">
                            <span class="block-banners__item-image"><img
                                    src="{{ asset('frontend/images/cache/banner1.fb4146d5d9e2a225936b610793f347872.jpg') }}"
                                    alt=""></span>
                            <span class="block-banners__item-image block-banners__item-image--blur"><img
                                    src="{{ asset('frontend/images/cache/banner1.fb4146d5d9e2a225936b610793f347872.jpg') }}"
                                    alt=""></span>
                        ...
                        <a href="{{ route('shop') }}" class="block-banners__item block-banners__item--style--one">
                            <span class="block-banners__item-image"><img
                                    src="{{ asset('frontend/images/cache/banner2.fb4146d5d9e2a225936b610793f347872.jpg') }}"
                                    alt=""></span>
                            <span class="block-banners__item-image block-banners__item-image--blur"><img
                                    src="{{ asset('frontend/images/cache/banner2.fb4146d5d9e2a225936b610793f347872.jpg') }}"
                                    alt=""></span>
        ...
        <!-- New Arrival -->
        @if ($new_arrivals && count($new_arrivals) > 0)
        <div class="block-space block-space--layout--divider-nl"></div>
