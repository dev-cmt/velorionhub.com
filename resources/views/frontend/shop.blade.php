                    ...
                    <div class="gridLayout-wrapper">
                        <div class="tf-grid-layout lg-col-4 md-col-3 sm-col-2 flat-grid-product wrapper-shop layout-tabgrid-1"
                            ...
                            <div class="card-product" data-condition="New" data-brand="steelseri2"
                                ...
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="product-img">
                                        <img class="img-product lazyload" src="{{asset($filePath)}}/images/product/product-8.jpg"
                                            data-src="{{asset($filePath)}}/images/product/product-8.jpg" alt="image-product">
                                        <img class="img-hover lazyload" src="{{asset($filePath)}}/images/product/product-99.jpg"
                                            data-src="{{asset($filePath)}}/images/product/product-99.jpg" alt="image-product">
                                    </a>
                            ...
                            <div class="card-product" data-condition="Old" data-brand="steelseri"
                                ...
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="product-img">
                                        <img class="img-product lazyload" src="{{asset($filePath)}}/images/product/product-9.jpg"
                                            data-src="{{asset($filePath)}}/images/product/product-9.jpg" alt="image-product">
                            ...
                            <div class="card-product" data-condition="New" data-brand="hyperx2" data-rate="2 Star">
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="product-img">
                                        <img class="img-product lazyload" src="{{asset($filePath)}}/images/product/product-34.jpg"
                                            data-src="{{asset($filePath)}}/images/product/product-34.jpg" alt="image-product">
                                        <img class="img-hover lazyload" src="{{asset($filePath)}}/images/product/product-15.jpg"
                                            data-src="{{asset($filePath)}}/images/product/product-15.jpg" alt="image-product">
                                    </a>
                                    <ul class="list-product-btn top-0 end-0">
                                        <li>
                                            <a href="#shoppingCart" data-bs-toggle="offcanvas"
                            ...
                            <div class="card-product" data-condition="New" data-brand="razer" data-rate="4 Star">
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="product-img">
                                        <img class="img-product lazyload" src="{{asset($filePath)}}/images/product/product-11.jpg"
                                            data-src="{{asset($filePath)}}/images/product/product-11.jpg" alt="image-product">
                                        <img class="img-hover lazyload" src="{{asset($filePath)}}/images/product/product-38.jpg"
                                            data-src="{{asset($filePath)}}/images/product/product-38.jpg" alt="image-product">
                                    </a>
                                    <ul class="list-product-btn top-0 end-0">
                                        <li>
                                            <a href="#shoppingCart" data-bs-toggle="offcanvas"
                            ...
                            <div class="card-product" data-rate="1 Star">
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="product-img">
                                        <img class="img-product lazyload" src="{{asset($filePath)}}/images/product/product-12.jpg"
                                            data-src="{{asset($filePath)}}/images/product/product-12.jpg" alt="image-product">
                                        <img class="img-hover lazyload" src="{{asset($filePath)}}/images/product/product-122.jpg"
                                            data-src="{{asset($filePath)}}/images/product/product-122.jpg" alt="image-product">
                                    </a>
                                    <ul class="list-product-btn top-0 end-0">
                                        <li>
                                            <a href="#shoppingCart" data-bs-toggle="offcanvas"
                            ...
                            <div class="card-product" data-brand="corsair" data-deal="Deal Today"
                                ...
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="product-img">
                                        <img class="img-product lazyload" src="{{asset($filePath)}}/images/product/product-13.jpg"
                                            data-src="{{asset($filePath)}}/images/product/product-13.jpg" alt="image-product">
                                        <img class="img-hover lazyload" src="{{asset($filePath)}}/images/product/product-137.jpg"
                                            data-src="{{asset($filePath)}}/images/product/product-137.jpg" alt="image-product">
                                    </a>
                                    <ul class="list-product-btn top-0 end-0">
                                        <li>
                                            <a href="#shoppingCart" data-bs-toggle="offcanvas"
                            ...
                            <div class="card-product" data-brand="jbl" data-deal="Deal Today" data-rate="3 Star">
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="product-img">
                                        <img class="img-product lazyload" src="{{asset($filePath)}}/images/product/product-14.jpg"
                                            data-src="{{asset($filePath)}}/images/product/product-14.jpg" alt="image-product">
                                        <img class="img-hover lazyload" src="{{asset($filePath)}}/images/product/product-143.jpg"
                                            data-src="{{asset($filePath)}}/images/product/product-143.jpg" alt="image-product">
                                    </a>
                                    <ul class="list-product-btn top-0 end-0">
                                        <li>
                                            <a href="#shoppingCart" data-bs-toggle="offcanvas"
                            ...
                            <div class="card-product" data-condition="Old" data-brand="hyperx2" data-rate="2 Star">
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="product-img">
                                        <img class="img-product lazyload" src="{{asset($filePath)}}/images/product/product-15.jpg"
                                            data-src="{{asset($filePath)}}/images/product/product-15.jpg" alt="image-product">
                                        <img class="img-hover lazyload" src="{{asset($filePath)}}/images/product/product-34.jpg"
                                            data-src="{{asset($filePath)}}/images/product/product-34.jpg" alt="image-product">
                                    </a>
                                    <ul class="list-product-btn top-0 end-0">
                                        <li>
                            ...
                            <div class="card-product" data-brand="logitech" data-deal="Deal Today"
                                ...
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="product-img">
                                        <img class="img-product lazyload" src="{{asset($filePath)}}/images/product/product-16.jpg"
                                            data-src="{{asset($filePath)}}/images/product/product-16.jpg" alt="image-product">
                                        <img class="img-hover lazyload" src="{{asset($filePath)}}/images/product/product-71.jpg"
                                            data-src="{{asset($filePath)}}/images/product/product-71.jpg" alt="image-product">
                                    </a>
                                    <ul class="list-product-btn top-0 end-0">
                                        <li>
                                            <a href="#shoppingCart" data-bs-toggle="offcanvas"
                            ...
                            <div class="card-product" data-condition="Old" data-brand="corsair" data-rate="1 Star">
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="product-img">
                                        <img class="img-product lazyload" src="{{asset($filePath)}}/images/product/product-17.jpg"
                                            data-src="{{asset($filePath)}}/images/product/product-17.jpg" alt="image-product">
                                        <img class="img-hover lazyload" src="{{asset($filePath)}}/images/product/product-103.jpg"
                                            data-src="{{asset($filePath)}}/images/product/product-103.jpg" alt="image-product">
                                    </a>
                                    <ul class="list-product-btn top-0 end-0">
                                        <li>
                                            <a href="#shoppingCart" data-bs-toggle="offcanvas"
                            ...
                            <div class="card-product" data-brand="steelseri2" data-rate="5 Star">
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="product-img">
                                        <img class="img-product lazyload" src="{{asset($filePath)}}/images/product/product-56.jpg"
                                            data-src="{{asset($filePath)}}/images/product/product-56.jpg" alt="image-product">
                                        <img class="img-hover lazyload" src="{{asset($filePath)}}/images/product/product-125.jpg"
                                            data-src="{{asset($filePath)}}/images/product/product-125.jpg" alt="image-product">
                                    </a>
                                    <ul class="list-product-btn top-0 end-0">
                                        <li>
                                            <a href="#shoppingCart" data-bs-toggle="offcanvas"
                            ...
                            <div class="card-product" data-brand="logitech" data-rate="3 Star">
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="product-img">
                                        <img class="img-product lazyload" src="{{asset($filePath)}}/images/product/product-19.jpg"
                                            data-src="{{asset($filePath)}}/images/product/product-19.jpg" alt="image-product">
                                        <img class="img-hover lazyload" src="{{asset($filePath)}}/images/product/product-52.jpg"
                                            data-src="{{asset($filePath)}}/images/product/product-52.jpg" alt="image-product">
                                    </a>
                                    <ul class="list-product-btn top-0 end-0">
                                        <li>
                                            <a href="#shoppingCart" data-bs-toggle="offcanvas"
        ...
        $(function() {
            ...
            $('.filter-item').on('click', function() {
                ...
                if (filterValue === 'all') {
                    ...
                    $('.card-product').hide();
                    $('.card-product[data-brand="' + filterValue + '"]').show();
                }
            });
             ...
             $('#sortSelect').on('change', function() {
                ...
                var products = $('.card-product').get();

                products.sort(function(a, b) {
                    var priceA = parseFloat($(a).find('.new-price').text().replace('$', ''));
                    var priceB = parseFloat($(b).find('.new-price').text().replace('$', ''));
