<x-frontend-layout title="404 Not Found">
    <!-- Breakcrumbs -->
    ...
    <section class="tf-sp-6">
        <div class="container">
            <div class="wg-404 text-center">
                ...
                <p class="notice title-normal fw-semibold"><span class="text-primary">Whoops!</span> {{ $exception->getMessage() ?: 'The requested resource was not found.' }}</p>
                <div class="box-btn">
