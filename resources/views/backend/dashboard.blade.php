                                        ...
                                        <div class="d-flex align-items-top flex-wrap">
                                            <div class="me-2">
                                                <span class="avatar avatar-sm avatar-rounded">
                                                    <img src="{{asset('backend')}}/images/faces/10.jpg" alt="">
                                                </span>
                                            </div>
                                            <div class="flex-fill">
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center fw-semibold">
                                                    <span class="avatar avatar-sm me-2 avatar-rounded">
                                                        <img src="{{asset('backend')}}/images/faces/4.jpg" alt="img">
                                                    </span>Mayor Kelly
                                                </div>
                                            </td>
                                            <td>Manufacture</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center fw-semibold">
                                                    <span class="avatar avatar-sm me-2 avatar-rounded">
                                                        <img src="{{asset('backend')}}/images/faces/15.jpg" alt="img">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center fw-semibold">
                                                    <span class="avatar avatar-sm me-2 avatar-rounded">
                                                        <img src="{{asset('backend')}}/images/faces/11.jpg" alt="img">
                                                    </span>Simon Cowel
                                                </div>
                                            </td>
                                            <td>Service</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center fw-semibold">
                                                    <span class="avatar avatar-sm me-2 avatar-rounded">
                                                        <img src="{{asset('backend')}}/images/faces/8.jpg" alt="img">
                                                    </span>Mirinda Hers
                                                </div>
                                            </td>
                                            <td>Marketing</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center fw-semibold">
                                                    <span class="avatar avatar-sm me-2 avatar-rounded">
                                                        <img src="{{asset('backend')}}/images/faces/9.jpg" alt="img">
                                                    </span>Jacob Smith
                                                </div>
                                            </td>
