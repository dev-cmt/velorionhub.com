                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="javascript:void(0)" class="customer_activity_btn"
                                                ...
                                                data-pathao_delivered="{{ data_get($activity, 'pathao.delivered', data_get($activity, 'Pathao.delivered', 0)) }}"
                                                data-pathao_returned="{{ data_get($activity, 'pathao.returned', data_get($activity, 'Pathao.returned', 0)) }}"
                                                data-redx_delivered="{{ data_get($activity, 'redx.delivered', data_get($activity, 'Redx.delivered', 0)) }}"
                                                data-redx_returned="{{ data_get($activity, 'redx.returned', data_get($activity, 'Redx.returned', 0)) }}"
                                                data-paperfly_delivered="{{ data_get($activity, 'paperfly.delivered', data_get($activity, 'Paperfly.delivered', 0)) }}"
                                                data-paperfly_returned="{{ data_get($activity, 'paperfly.returned', data_get($activity, 'Paperfly.returned', 0)) }}"
                                                data-steadfast_delivered="{{ data_get($activity, 'steadfast.delivered', data_get($activity, 'SteadFast.delivered', 0)) }}"
                                                data-steadfast_returned="{{ data_get($activity, 'steadfast.returned', data_get($activity, 'SteadFast.returned', 0)) }}"
                                                data-carrybee_delivered="{{ data_get($activity, 'carrybee.delivered', data_get($activity, 'Carrybee.delivered', 0)) }}"
                                                data-carrybee_returned="{{ data_get($activity, 'carrybee.returned', data_get($activity, 'Carrybee.returned', 0)) }}"
