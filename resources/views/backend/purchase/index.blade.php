<x-backend-layout title="Purchase Management">

    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
        <h1 class="page-title fw-semibold fs-18 mb-0">Purchase Management</h1>
            ...
            <div class="card custom-card">
                <div class="card-header justify-content-between">
                    ...
                    <div class="prism-toggle">
                        <a href="{{ route('purchase.create') }}" type="button"
                            class="btn btn-sm btn-success-gradient">Add
                            Purchase</a>
                    </div>
                </div>
                <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="hstack gap-2 flex-wrap justify-content-end">
                                                    <a href="javascript:void(0);" class="text-info fs-14 lh-1 view_btn"
                                                        data-id="{{ $item->id }}">
                                                        <i class="ri-eye-line"></i>
                                                    </a>
                                                    @if ($item->status == 0)
                                                        <a href="{{ route('purchase.edit', $item->id) }}"
                                                            class="text-info fs-14 lh-1 edit-btn">
